...
package com.android.screenspeak.volumebutton;
...
public class DoubleVolumeButtonTreeShortPressPatternMatcher extends VolumeButtonPatternMatcher {
    ...
    public DoubleVolumeButtonTreeShortPressPatternMatcher() {
        super(VolumeButtonPatternDetector.TWO_BUTTONS_THREE_PRESS_PATTERN,
    ...
    private void updateCounters() {
        if (mLastVolumeUpAction != null && !mLastVolumeUpAction.pressed &&
                mLastVolumeDownAction != null && !mLastVolumeDownAction.pressed) {
            mDoubleButtonPresses++;
            mLastDoubleButtonPressEndTimestamp = Math.max(mLastVolumeUpAction.endTimestamp,
                    mLastVolumeDownAction.endTimestamp);
