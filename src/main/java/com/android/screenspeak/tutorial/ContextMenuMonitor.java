...
/**
 * A receiver that listens for and responds to actions performed on ScreenSpeak
 * context menus.
 */
public class ContextMenuMonitor extends BroadcastReceiver {
    public static final String ACTION_CONTEXT_MENU_SHOWN =
            "com.android.screenspeak.tutorial.ContextMenuShownAction";
    public static final String ACTION_CONTEXT_MENU_HIDDEN =
            "com.android.screenspeak.tutorial.ContextMenuHiddenAction";
    public static final String ACTION_CONTEXT_MENU_ITEM_CLICKED =
            "com.android.screenspeak.tutorial.ContextMenuItemClickedAction";
    public static final String EXTRA_MENU_ID =
            "com.android.screenspeak.tutorial.MenuIdExtra";
    public static final String EXTRA_ITEM_ID =
            "com.android.screenspeak.tutorial.ItemIdExtra";
    ...
    /** A delegate for handling actions performed on ScreenSpeak context menus. */
    public interface ContextMenuListener {
        ...
        /**
         * Handles an item clicked on the ScreenSpeak Global Context Menu.
         * <p>
