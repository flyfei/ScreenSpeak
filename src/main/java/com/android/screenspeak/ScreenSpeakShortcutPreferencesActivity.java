...
/**
 * Activity used to set ScreenSpeak's gesture preferences.
 */
public class ScreenSpeakShortcutPreferencesActivity extends PreferenceActivity {
     ...
     * the UI if ScreenSpeak hasn't been enabled to remap the preference value.
     */
    private void fixUnboundPrefSummary(Preference pref) {
        ...
        if (mGesturePrefKeys.contains(prefKey)) {
            ...
            // the user chooses a new mapping, or ScreenSpeakUpdateHelper gets a
