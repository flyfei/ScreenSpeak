...
public class EventSpeechRule {
     ...
     * the former is not provided resources are loaded form the ScreenSpeak
     * context. If the latter is not provided class are loaded from the current
     * ScreenSpeak APK. The speech rule content is loaded from a DOM <code>node</code>
     ...
     */
    private EventSpeechRule(ScreenSpeakService context, Node node, int ruleIndex) {
        mContext = context;
        mNode = node;
     ...
     */
    public static ArrayList<EventSpeechRule> createSpeechRules(ScreenSpeakService context,
    ...
    private class DefaultFormatter implements AccessibilityEventFormatter {
        ...
        @Override
        public boolean format(AccessibilityEvent event, ScreenSpeakService context,
                Utterance utterance) {
    ...
    public interface AccessibilityEventFilter {
         ...
         */
        boolean accept(AccessibilityEvent event, ScreenSpeakService context);
    }
