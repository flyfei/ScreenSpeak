...
import com.android.screenspeak.DimmingOverlayView;
...
public class DimScreenControllerApp implements DimScreenController,
    ...
    private SharedPreferences.OnSharedPreferenceChangeListener mPrefListener =
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            if (key.equals(mContext.getString(R.string.pref_dim_when_screenspeak_enabled_key))) {
                if (ScreenSpeakService.isServiceActive() && isDimmingEnabled()) {
                    makeScreenDim();
                } else {
                    makeScreenBright();
                }
    ...
    public void switchState() {
        if (!mIsDimmed && ScreenSpeakService.isServiceActive()) {
            makeScreenDim();
        } else {
            makeScreenBright();
        }
