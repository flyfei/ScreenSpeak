...
public class GestureChangeNotificationActivity extends Activity {
    ...
    private final int[] mActionNameRes = {
            ...
            R.string.shortcut_screenspeak_breakout,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final CharSequence dialogMessage = getString(
                R.string.screenspeak_gesture_change_details,
        ...
        final OnClickListener customizeButtonListener = new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                final Intent shortcutsIntent = new Intent(
                        ...
                        ScreenSpeakShortcutPreferencesActivity.class);
    ...
    private void dismissNotification() {
        final int notificationId = ScreenSpeakUpdateHelper.GESTURE_CHANGE_NOTIFICATION_ID;
        final NotificationManager nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        nm.cancel(notificationId);

        // Clear the flag signaling ScreenSpeak to display the notification again
        final SharedPreferences.Editor editor = mPrefs.edit();
