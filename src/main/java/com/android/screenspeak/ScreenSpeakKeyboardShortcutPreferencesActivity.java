...
/**
 * Activity used to set ScreenSpeak's keyboard shortcut preferences.
 */
public class ScreenSpeakKeyboardShortcutPreferencesActivity extends PreferenceActivity {
