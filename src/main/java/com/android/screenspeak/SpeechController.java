...
public class SpeechController {
    ...
    private static final String UTTERANCE_ID_PREFIX = "screenspeak_";
    ...
    public SpeechController(ScreenSpeakService context,
                            FeedbackController feedbackController) {
        if (feedbackController == null) throw new IllegalStateException();

        mService = context;
        mService.addServiceStateListener(new ScreenSpeakService.ServiceStateListener() {
            @Override
            public void onServiceStateChanged(int newState) {
                if (newState == ScreenSpeakService.SERVICE_STATE_ACTIVE) {
