...
package com.android.screenspeak.labeling;
...
/**
 * Tests for {@link com.android.screenspeak.labeling.LabelProvider}.
 */
...
public class LabelProviderTest extends ProviderTestCase2<LabelProvider> {
    ...
    /**
     * Tests URI matching in {@link com.android.screenspeak.labeling.LabelProvider}.
     * <p>
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#insert(android.net.Uri, android.content.ContentValues)} with an invalid
     * URI argument.
     */
    @SmallTest
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#insert(android.net.Uri, android.content.ContentValues)} with {@code null}
     * content values.
     */
    @SmallTest
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#insert(android.net.Uri, android.content.ContentValues)} with empty content
     * values.
     */
    @SmallTest
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#insert(android.net.Uri, android.content.ContentValues)} with an extra
     * content value.
     */
    @SmallTest
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#insert(android.net.Uri, android.content.ContentValues)} with specified
     * label ID.
     */
    @SmallTest
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#insert(android.net.Uri, android.content.ContentValues)} with valid content
     * values.
     */
    @SmallTest
     ...
     * {@link com.android.screenspeak.labeling.LabelProvider#query(android.net.Uri, String[], String, String[], String)} with
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#update(android.net.Uri, android.content.ContentValues, String, String[])}
     ...
     * <p>
     * Note: This test depends on {@link com.android.screenspeak.labeling.LabelProvider#insert} functionality.
     */
    @SmallTest
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#delete(android.net.Uri, String, String[])}
     * with an invalid URI parameter.
     */
    @SmallTest
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#delete(android.net.Uri, String, String[])} with valid
     * arguments.
     * <p>
     * Note: This test depends on {@link com.android.screenspeak.labeling.LabelProvider#insert} functionality.
     */
    ...
    /**
     * Tests {@link com.android.screenspeak.labeling.LabelProvider#delete(android.net.Uri, String, String[])} with a
     * selection argument.
     * <p>
