...
public class TextFormattersTest extends ScreenSpeakInstrumentationTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        assertNotNull("Obtained ScreenSpeak instance", mScreenSpeak);
    }
    ...
    public void testSelectedTextFormatter_moveCursorWithVolumeButtons() {
        ...
        mScreenSpeak.getCursorController().setCursor(getNodeForId(R.id.username));
     ...
     * delivering the volume key events to ScreenSpeak.
     */
