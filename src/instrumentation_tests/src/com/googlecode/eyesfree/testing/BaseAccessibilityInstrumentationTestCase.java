...
public abstract class BaseAccessibilityInstrumentationTestCase
    ...
    protected void disableAllServices() {
        ...
        // Touch exploration is only supported on ICS and above.
     ...
     * <p>
     * <b>Prior to Jelly Bean:</b> Setting {@code usesExploreByTouch} will
     * enable Explore by Touch.
     * <p>
     * <b>Jelly Bean and above:</b> Setting {@code usesExploreByTouch} grants
    ...
    protected void enableService(String packageName, String className, boolean usesExploreByTouch) {
        ...
        // Touch exploration is only supported on ICS and above, and should only
        // be forced on for platforms prior to JB.
        if (usesExploreByTouch
