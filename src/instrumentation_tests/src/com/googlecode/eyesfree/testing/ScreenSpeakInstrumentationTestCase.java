...
public class ScreenSpeakInstrumentationTestCase extends BaseAccessibilityInstrumentationTestCase {
    private static final String TARGET_PACKAGE = BuildConfig.APPLICATION_ID;
    private static final String TARGET_CLASS = "com.google.android.marvin.screenspeak.ScreenSpeakService";
    ...
    @Override
    protected ScreenSpeakService getService() {
        mService = ScreenSpeakService.getInstance();
    ...
    protected void enableTargetService() {
        ...
        // Prevent ScreenSpeak from automatically opening the tutorial.
    ...
    private final ScreenSpeakListener mTestingListener = new ScreenSpeakListener() {
        @Override
        public void onAccessibilityEvent(AccessibilityEvent event) {
            onEventReceived(event);
        }

        // Note: This method is called on the ScreenSpeak service thread.
        @Override
