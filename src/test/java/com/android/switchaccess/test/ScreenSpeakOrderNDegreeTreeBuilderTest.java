...
public class ScreenSpeakOrderNDegreeTreeBuilderTest {
    ...
    public void buildTreeWithHigherDegreeThanNodesAvailable_hasExpectedStructure() {
        ...
        ScreenSpeakOrderNDegreeTreeBuilder treeBuilder = new ScreenSpeakOrderNDegreeTreeBuilder(mContext);
        ...
        OptionScanSelectionNode treeRoot = (OptionScanSelectionNode) treeBuilder
                .buildTreeFromWindowList(mExtendedWindows, new ClearFocusNode());
    ...
    public void buildTreeWithZeroLengthWindowList_hasContextMenu() {
        ScreenSpeakOrderNDegreeTreeBuilder treeBuilder = new ScreenSpeakOrderNDegreeTreeBuilder(mContext);
        OptionScanNode treeRoot = treeBuilder.buildTreeFromWindowList(
    ...
    public void buildTreeWithNullWindowListNullContextMenu_hasOnlyClearFocusNode() {
        ScreenSpeakOrderNDegreeTreeBuilder treeBuilder = new ScreenSpeakOrderNDegreeTreeBuilder(mContext);
        OptionScanNode treeRoot = treeBuilder.buildTreeFromWindowList(null, null);
        assertTrue(treeRoot instanceof ClearFocusNode);
        treeRoot.recycle();
    }
    ...
    public void buildDegreeThreeFullTree_hasExpectedStructure() {
        ...
        OptionScanSelectionNode treeRoot = (OptionScanSelectionNode) treeBuilder
                .buildTreeFromWindowList(mExtendedWindows, contextMenuTree);
    ...
    public void buildNoActionsContextMenuTree_hasOnlyClearFocusNode() {
        ScreenSpeakOrderNDegreeTreeBuilder treeBuilder = new ScreenSpeakOrderNDegreeTreeBuilder(mContext);
        List<GlobalActionNode> actions = new ArrayList<>();
        OptionScanNode contextMenuTree = treeBuilder.buildContextMenuTree(actions);
    ...
    public void buildContextMenuTree_order2_hasExpectedStructure() {
        ScreenSpeakOrderNDegreeTreeBuilder treeBuilder = new ScreenSpeakOrderNDegreeTreeBuilder(mContext);
        GlobalActionNode globalNode0 = new GlobalActionNode(0, null, null);
        GlobalActionNode globalNode1 = new GlobalActionNode(1, null, null);
        GlobalActionNode globalNode2 = new GlobalActionNode(2, null, null);

        ContextMenuNode contextMenuTree = (ContextMenuNode) treeBuilder
                .buildContextMenuTree(Arrays.asList(globalNode0, globalNode1, globalNode2));
    ...
    public void buildContextMenuTree_order3_hasExpectedStructure() {
        ...
        GlobalActionNode globalNode1 = new GlobalActionNode(1, null, null);
        GlobalActionNode globalNode2 = new GlobalActionNode(2, null, null);
        GlobalActionNode globalNode3 = new GlobalActionNode(3, null, null);

        ContextMenuNode contextMenuTree = (ContextMenuNode) treeBuilder.buildContextMenuTree(
    ...
    private void configureNumOptionScanningSwitches(int num) {
        assertTrue(num > 0);
        assertTrue(num <= ScreenSpeakOrderNDegreeTreeBuilder.OPTION_SCAN_SWITCH_CONFIG_IDS.length);
        SharedPreferences.Editor prefEditor =
                PreferenceManager.getDefaultSharedPreferences(mContext).edit();
        for (int i = 0; i < ScreenSpeakOrderNDegreeTreeBuilder.OPTION_SCAN_SWITCH_CONFIG_IDS.length;
                i++) {
            String prefKey = mContext
                    .getString(ScreenSpeakOrderNDegreeTreeBuilder.OPTION_SCAN_SWITCH_CONFIG_IDS[i]);
